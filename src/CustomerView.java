...
public class CustomerView extends BorderPane {
    ...
    /**
     * Constructs a CustomerView linked to the specified controller.
     * Initializes the UI and displays products grouped by category.
     *
     * @param controller the ShoppingController responsible for business logic
     */
    ...
    /**
     * Initializes the main user interface, including top bar, product tabs, and bottom bar.
     */
    ...
    /**
     * Creates the top bar showing store name, location, customer info, and logout button.
     *
     * @return the HBox containing top bar components
     */
    ...
    /**
     * Creates the bottom bar with cart display and view cart button.
     *
     * @return the HBox containing bottom bar components
     */
    ...
    /**
     * Organizes the products by main category and subcategory.
     *
     * @return a nested Map of main categories to subcategories and their product lists
     */
    ...
    /**
     * Creates a main category tab containing subcategory tabs.
     *
     * @param mainCategory the name of the main category
     * @param subCategories a map of subcategory names to product lists
     * @return the Tab representing the main category
     */
    ...
    /**
     * Creates a subcategory tab containing all products in a FlowPane.
     *
     * @param subCategory the subcategory name
     * @param products the list of products in this subcategory
     * @return the Tab representing the subcategory
     */
    ...
    /**
     * Creates a visual card for a product showing details, stock, price, expiration, and add-to-cart button.
     *
     * @param product the Product to display
     * @return a VBox containing all UI elements for the product
     */
    ...
    /**
     * Updates the cart item count display in the bottom bar.
     * Should be called whenever the cart contents change.
     */
